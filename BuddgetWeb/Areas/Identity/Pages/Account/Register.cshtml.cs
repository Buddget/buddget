...
namespace BuddgetWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                _roleManager.CreateAsync(new IdentityRole<int>(SD.RoleUser)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole<int>(SD.RoleAdmin)).GetAwaiter().GetResult();
            }
